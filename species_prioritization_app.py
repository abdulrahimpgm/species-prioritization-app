...
with st.sidebar:
    ...
    **Affiliation:** Terrestrial Ecology and Modelling (TEaM) Lab, SRM University-AP, India, Centre for Biodiversity Studies, Baba Ghulam Shah Badshah University, Rajouri, Jammu and Kashmir, India   
    **Version:** v1.0  
    **Year:** 2025
    """)
